...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="col-xs-12 form-group">
                    {!! Form::label('total_capacity', 'Attaending Capacity*', ['class' => 'control-label']) !!}
                    {!! Form::number('total_capacity', old('total_capacity'), ['class' => 'form-control', 'min'=>'0', 'placeholder' => '', 'required'=>'']) !!}
                    <p class="help-block"></p>
